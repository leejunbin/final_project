...
<body id="page-top">
  ...
  <!-- Page level plugins -->
  <script src="${cp}/resources/admin/admin-boot/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="${cp}/resources/admin/admin-boot/js/demo/chart-area-demo.js"></script>
  <script src="${cp}/resources/admin/admin-boot/js/demo/chart-pie-demo.js"></script>
